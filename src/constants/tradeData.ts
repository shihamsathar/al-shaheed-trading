...
// Enterprise Institutional Accounts for All 4 Roles
export const INITIAL_USERS: User[] = [
  ...
  },
  {
    ...
    country: 'Qatar',
    city: 'Doha',
    address: 'Industrial Area, Street 24, Zone 57, Doha',
    commodityCategories: ['Metal Scrap', 'Industrial Recyclables & Equipment'],
    typicalVolume: '2,500 MT / Month',
  ...
  },
  {
    ...
    country: 'Qatar',
    city: 'Doha',
    address: 'Mesaieed Industrial Zone, Qatar',
  ...
  {
    id: 'usr-agt-01',
    email: 'agent@gulfbrokers.com',
    username: 'agent',
    name: 'Farhan Siddiqui',
    role: 'AGENT',
    companyName: 'Gulf Scrap Trading & Sourcing Agency',
    phone: '+974 66778899',
    country: 'Qatar',
    city: 'Doha',
    commodityCategories: ['Metal Scrap', 'Paper Waste', 'Industrial Recyclables & Equipment'],
    tradingRegion: 'GCC & South Asia',
